...
from .helper import map_fourvector_rambo, two_body_decay_factor, boost, boost_beam
...
class RamboOnDiet(PhaseSpaceGenerator):
...
class RamboOnDietHadron(PhaseSpaceGenerator):
